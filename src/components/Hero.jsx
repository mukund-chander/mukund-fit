...
export default function Hero() {
  return (
    <div
      className="min-h-screen flex flex-col gap-10 items-center justify-center text-center max-w-[900px] w-full mx-auto
    p-4"
    >
      ...
      <p className="text-sm md:text-base font-light">
        ...
        <span className="text-blue-400 font-medium">
          unbelievebaly swolenormous{" "}
        </span>
        and accept all risks of becoming the local{" "}
        <span className="text-blue-400 font-medium">mass monstrocity</span>,
